...
module.exports = {
  ...
  caption: process.env.CAPTION || "𝐅𝐈𝐋𝐄-𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃-𝐁𝐘- PAK News Media Group",
  author: process.env.PACK_AUTHER || "WASO",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "MQR",
  ownername: process.env.OWNER_NAME || "MQR",
  errorChat: process.env.ERROR_CHAT || "923219753270",
